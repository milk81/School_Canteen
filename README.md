...
__Цель проекта__: Разработка веб-приложения для автоматизации работы школьной столовой, обеспечивающего удобный заказ и оплату питания, контроль учета продуктов и прозрачную систему отчетности.
